...
export function ChatComposer() {
    const { composerText, isSoundEnabled, sendMediaMessage, isSendingMedia, sendTextMessage, setComposerText } = useChatStore();
    const { activeChatId } = useSelectedChat();
    ...
    const handleSend = async () => {
        const didSendMessage = await sendTextMessage(activeChatId);
